...
jQuery.fn.jmp3 = function(passedOptions){
	// hard-wired options
	var playerpath = "http://local.cdn.pengpengla.com/upmusic/@@version/images/";					// SET THIS FIRST: path to singlemp3player.swf
	...
	return this.each(function(){
		...
		if(jQuery.browser && jQuery.browser.msie){ this.outerHTML = this.outerHTML; }
	});
};